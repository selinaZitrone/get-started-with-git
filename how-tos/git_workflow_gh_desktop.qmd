...
### Option 1: You are collaborating on a Github repository
...
### Option 2: Works for all repository

This option works for Github repositories but also for others like Gitlab.
