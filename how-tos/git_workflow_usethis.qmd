---
title: "A Git workflow with the R and `usethis`"
execute: 
  eval: false
---
...
For this workflow, you need the [`usethis`](https://usethis.r-lib.org/) package. It is a very cool workflow package that has a lot of functionality including Git workflows.
...
you need to setup a Personal Access Token (PAT). Follow the steps below.
