...
You can manage access to Github with a personal access token (PAT) instead of using your password. 
...
This will tell you if you already have a token and if not how you can create one.
To create a new token, call the function:
