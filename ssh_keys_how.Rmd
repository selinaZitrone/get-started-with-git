...
If you don't have an SSH key set up, please follow the steps from the Github documentation below. Make sure 
that on top of the website, your correct operating system is selected to get the correct guide (should happen automatically but you never know).
