In these tasks, you will create your own Git cook book :ramen:.
...
In the tasks, I will not describe all steps in detail (e.g. where you have to click exactly).

But if you are stuck at some step you can find help here:

- [A cheatsheet for the Github Desktop GUI](../gh_desktop_cheatsheet.qmd): Explains all the buttons and windows of Github Desktop
- [A How-To description](../how-tos/git_workflow_gh_desktop.qmd) of the Git workflow with detailed explanations and Screenshots

:::{.panel-tabset}

# 1 Local repository (10 min)

## Create your own Git cook book :ramen:
...
Do you see the hidden `.git` foder in there?
...
::: {.callout-note}
Note that you cannot work on the project in this state. 
