...
Switch back to your local repo and make some more changes.
Commit them, push them to GitHub and check out how they look online.
...
Make some changes to an existing recipe file, but do not commit them.
See how GitHub Desktop recognizes these changes.
Now, right-click on the changed file and select **Discard changes**.
...
Find a random file on your computer (e.g. a PDF, an Excel file, ...) and copy it into your cook book folder.
...
Have a look at the newly created `.gitignore` file. You can just commit and push changes to
a `.gitignore` file like with any other file.
